              ...
              <ul class="list-group list-group-flush">
                  ...
                  <div class="widget-content p-0">
                    <div class="widget-content-wrapper">
                      <div class="widget-content-left mr-3">
                        <img width="42" class="rounded-circle" src="@/assets/images/avatars/telefonica.png" alt="">
                      </div>
                ...
                <li class="list-group-item">
                  <div class="widget-content p-0">
                    <div class="widget-content-wrapper">
                      <div class="widget-content-left mr-3">
                        <img width="42" class="rounded" src="@/assets/images/avatars/telefonica.png" alt="">
                      </div>
                      <div class="widget-content-left">
                ...
                <li class="list-group-item">
                  <div class="widget-content p-0">
                    <div class="widget-content-wrapper">
                      ...
                      <div class="widget-content-right">
                        <div class="widget-numbers text-primary"><span class="count-up-wrapper">
                          <ICountUp
                            :startVal="startVal"
                            :endVal="endVal"
                            :decimals="decimals"
