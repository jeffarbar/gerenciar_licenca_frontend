      ...
      <b-container fluid>
        ...
        <b-table :striped="true"
          ...
          <template #cell(actions)="row">
            ...
            <b-button class="border-0 btn-transition btn btn-outline-vivo" size="sm" @click="$router.push( `/sharingUserRegister/${row.item.id}` )">
  ...
  export default {
    ...
    data() {
      return {
        ...
        subheading: 'Lista de usuário sharing.',
        icon: 'pe-7s-drawer icon-gradient bg-happy-itmeo',
        link: '/sharingUserRegister',
