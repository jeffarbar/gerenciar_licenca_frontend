    ...
    <b-card>
      <b-container fluid>
        ...
        <b-table :striped="true"
          ...
          <template #empty>
            <p align="center">Não existe Sharing.</p>
          </template>

          <template #cell(actions)="row">

            <b-button class="border-0 btn-transition btn btn-outline-vivo" size="sm" @click="$router.push( `/sharingCustomerRegister/${row.item.id}` )">
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        heading: 'Sharing',
        subheading: 'Lista de Sharing.',
        icon: 'pe-7s-drawer icon-gradient bg-happy-itmeo',
        link: '/sharingCustomerRegister',
