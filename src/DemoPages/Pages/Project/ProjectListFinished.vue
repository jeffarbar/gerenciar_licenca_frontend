      ...
      <b-container fluid>
        ...
        <b-table :striped="true"
          ...
          <template #cell(actions)="row">
            ...
            <b-button class="border-0 btn-transition btn btn-outline-vivo" size="sm" @click="$router.push( `/projectRegisterFinished/${row.item.id}` )">
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        heading: 'Projeto Finalizado',
        subheading: 'Lista de projetos finalizados.',
