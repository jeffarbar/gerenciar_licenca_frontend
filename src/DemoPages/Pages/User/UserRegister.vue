      ...
      <div class="main-card mb-3 card">
        <div class="card-body">
          <form @submit.prevent="save" class="">
            ...
            <div class="form-row">
              <div class="col-md-6">
                <div v-if="master" class="position-relative form-group">
                  <label for="senha" class="">Perfil</label>
                  <b-form-checkbox name="check" id="perfilAdministrador"  v-model="usuario.perfilAdministrador">
                   <label  class="text-vivo">Usuário administrador ?</label>
                  </b-form-checkbox>
                </div>
              </div>
            </div>
...
<script>
  ...
  export default {
    ...
    data: () => ({
      heading: 'Usuário',
      subheading: 'Cadastrado de usuário.',
